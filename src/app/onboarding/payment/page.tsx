...
function PaymentPageContent() {
  ...
  return (
    <div className="max-w-xl mx-auto px-4 py-16">
      ...
      {canceled && (
        <div className="flex items-center gap-3 bg-amber-50 border border-amber-200 rounded-xl px-4 py-3 text-amber-800 mb-6">
          <AlertCircle size={18} />
      ...
      <div className="bg-white rounded-2xl border-2 border-yellow-400 shadow-lg p-8 mb-6">
        <div className="flex items-start justify-between mb-6">
          <div>
            <h2 className="text-xl font-bold text-gray-900">MineApply Monthly</h2>
            <p className="text-gray-600 text-sm mt-1">Everything to get hired in mining</p>
          </div>
