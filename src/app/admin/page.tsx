    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-5xl mx-auto px-4 py-10">
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Mining Companies</h1>
          ...
          <div className="bg-white rounded-2xl border border-yellow-200 p-6 mb-6">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex items-center gap-2 border border-gray-200 text-gray-600 hover:bg-gray-50 px-4 py-2 rounded-xl text-sm transition-colors"
              >
                <X size={14} />
                Cancel
              </button>
                    ...
                    <>
                      <td className="px-6 py-3">
                        <input
                          ...
                          className="border border-gray-200 rounded-lg px-3 py-1.5 text-sm w-full focus:outline-none focus:ring-2 focus:ring-yellow-400"
                        />
                      </td>
                      <td className="px-6 py-3">
                        <input
                      ...
                      <td className="px-4 py-3">
                        <select
                          ...
                          className="border border-gray-200 rounded-lg px-2 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-yellow-400"
                        >
                          {["WA", "QLD", "NSW", "VIC", "SA", "NT", "TAS", "ACT"].map((s) => (
                            <option key={s} value={s}>{s}</option>
                          ))}
